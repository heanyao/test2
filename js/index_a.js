        ...
        timer = setInterval(function () {
            ...
            if (t === 200) {
                ...
                if (hoverFlag === 0) {//全球
                    ...
                    moreBtn.attr('href', _serverUrl + "/morecities/" + flag);
            ...
            success: function (res) {
                ...
                if (res.data.length && res.data.length > 0) {
                    $.each(res.data, function (index, item) {
                        t += '<a class="tableContentItem" href="' + _serverUrl + '/' + item.id + '">' +
            ...
            success: function (res) {
                ...
                if (arr.length && arr.length > 0) {
                    ...
                    $.each(arr, function (index, item) {
                        t += '<a class="theCountryHouseItem" href="' + _serverUrl + '/' + item.id + '">' +
